<template>
    <div class="weekCard">
        <b-card v-if= ((!week.reserved)&compare(week.date)) border-variant="dark" class="text-center">
            ...
            <b-card-text>
                <b-button class="transparentButton btn-block" v-if="week.auction" v-on:click="closeAuction">Cerrar subasta</b-button>
                <b-button class="transparentButton btn-block" v-else v-on:click="openAuction">Abrir subasta</b-button>
